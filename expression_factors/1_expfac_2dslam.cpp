// borrowed from:
// https://github.com/borglab/gtsam/blob/develop/examples/Pose2SLAMExampleExpressions.cpp
...
int main() {
  ...
  // define factor graph
  auto n_model = noiseModel::Diagonal::Sigmas(
      Vector3(0.2, 0.2, 0.1));  //< note that these noise factors depend on
                                // dimension of residue function
